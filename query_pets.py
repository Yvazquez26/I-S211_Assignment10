...
# Assignment 10 - Relational Databases: SQL and SQLite
# A script ​which will connect to the database and ask the user for a person’s ID number to print out data on person and
# all data on that person's pet.
